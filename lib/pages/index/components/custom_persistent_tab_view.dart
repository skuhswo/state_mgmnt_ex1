...
class MyPersistentTabView extends MyPersistentTabViewBase {
  ...
  MyPersistentTabView(this.context,
      {Key key,
...
class MyPersistentTabViewBase extends StatefulWidget {
  ...
  @override
  MyPersistentTabViewState createState() => MyPersistentTabViewState();
}

class MyPersistentTabViewState extends State<MyPersistentTabView> {
  ...
  BuildContext getContextForIndex({int i = 0}) {
